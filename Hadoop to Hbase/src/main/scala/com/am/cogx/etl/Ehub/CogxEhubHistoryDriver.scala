...
object CogxEhubHistoryDriver extends Logging {
    ...
    try {
      ...
      (new CogxEhubHistoryOperation(confFilePath, env, queryFileCategory)).operation()
      info(s"Cogx Ehub History Completed at: " + DateTime.now())
